...
namespace Qv2ray::base::config
{
    ...
    struct Qv2rayConfig_Kernel
    {
        bool enableAPI = true;
        int statsPort = 15490;
        QString preferredKernel = "sing-box"; // v2ray|xray|mihomo|sing-box
        bool usePolyCoreManager = false;       // opt-in to PolyCore multi-kernel manager
        bool useClashAPIStats = true;          // poll Clash-compatible stats (sing-box/mihomo)
        QString apiHost = "127.0.0.1";         // controller host for stats
        //
...
#undef _VARNAME_VASSETSPATH_
        ...
        JSONSTRUCT_COMPARE(Qv2rayConfig_Kernel, enableAPI, statsPort, preferredKernel, usePolyCoreManager, useClashAPIStats, apiHost, //
        ...
        JSONSTRUCT_REGISTER(Qv2rayConfig_Kernel,                     //
                            F(enableAPI, statsPort, preferredKernel, usePolyCoreManager, useClashAPIStats, apiHost),//
