...
namespace Qv2ray::core::handler
{
    ...
    bool QvConfigHandler::SetConnectionPreferredKernel(const ConnectionId &id, const QString &preferredKernel)
    {
        CheckValidId(id, false);
        auto meta = connections[id];
        meta.preferredKernel = preferredKernel;
        connections[id] = meta;
        SaveConnectionConfig();
