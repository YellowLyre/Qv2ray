    ...
    , private Ui::PreferencesWindow
{
  ...
  private slots:
    ...
    void on_preferredKernelCombo_currentIndexChanged(int);
    void on_usePolyCoreCB_stateChanged(int arg1);
    void on_kernelRescanBtn_clicked();
    void on_kernelSetPreferredBtn_clicked();
    void on_kernelListTable_itemDoubleClicked(QTableWidgetItem *item);
    void on_testKernelBtn_clicked();
    void on_refreshKernelVersionBtn_clicked();
    void on_useClashAPIStatsCB_stateChanged(int arg1);
    void on_apiHostTxt_textEdited(const QString &arg1);
    void on_testApiBtn_clicked();
